...
__description__ = Description(
    ...
    FuncDescription('help', 'Выводит список плагинов/команд.Пример: .help(вывод плагинов), .help 2(вывод плагинов на 2 странице), .help ModuFlex(показывает команды плагина), help ModuFlex 2(показывает команды плагина на 2 странице). Также можно искать плагины/команды по регулярному выражению: .help --search (выражение)', parameters=['страница/имя плагина/--search (не обязательно)', 'страница/выражение(не обязательно)'], prefixes=['.', '/', '!']),
    ...
    FuncDescription('webi', 'Проверяет у плагина, имеется ли страница на локальном сайте.', prefixes=['.', '/', '!'], parameters=['имя плагина'])
)
